...
public class FormIngresos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_ingresos);
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle("Agregar Ingreso"); // Cambia esto con el título deseado
    ...
    private void obtenerCategoriasIngresos() {
        Call<List<Category>> call = apiService.obtenerCategoryIncome();
